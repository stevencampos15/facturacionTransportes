...
public class FrmFactura extends javax.swing.JInternalFrame {
                        ...
                        try {
                            ...
                            if (tblDetalleFactura.getRowCount() != 0 && tblDetalleFactura.getColumnCount() != 0) {
                                for (int i = 0; i < tblDetalleFactura.getRowCount(); i++) {
                                    ...
                                    int idProducto = tblDetalleFactura.getValueAt(i, 0).toString().indexOf("-");
                                    Producto prod = new Producto();
                                    prod.setIdProducto(idProducto);
                                    int idTipoVenta = tblDetalleFactura.getValueAt(i, 4).toString().indexOf("-");
    ...
    private void establecerFecha() {
        ...
        this.txtFecha.setText(dtf.format(localDate));
    }
